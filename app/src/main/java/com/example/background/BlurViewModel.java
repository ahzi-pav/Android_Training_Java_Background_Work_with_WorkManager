...
public class BlurViewModel extends ViewModel {
    ...
    private LiveData<List<WorkInfo>> mSavedInfo;
    ...
    public BlurViewModel(@NonNull Application application) {
        ...
        mSavedInfo = mWorkManager.getWorkInfosByTagLiveData(TAG_OUTPUT);
    }
    ...
    LiveData<List<WorkInfo>> getOutputWorkInfo() { return mSavedInfo; }
